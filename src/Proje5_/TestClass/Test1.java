package Proje5_.TestClass;

import Proje5_.Mortgage.HousePrices;
import Proje5_.Mortgage.StatesTax;
...
public class Test1 {
   ...
   public void test1() {
        ...
        Assert.assertEquals("Result should be 123200 but your result is " + total, 168000, total);
        Assert.assertEquals("Result should be 2773 but your result is " + eachMonth, 3933, eachMonth);
