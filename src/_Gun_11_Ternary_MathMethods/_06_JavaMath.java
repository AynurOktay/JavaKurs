...
public class _06_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("round3.5" +Math.round(3.5)); //4
        System.out.println("ceil 3.1="+ Math.ceil(3.1));// bu rakamdan buyuk en yakin tam sayiyi verir
        System.out.println("floor 3.5=" +Math.floor(3.5)); // bu rakamdan kucuk en yakin tam sayi
